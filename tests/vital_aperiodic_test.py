...
from hathorprocessing import vital_aperiodic
from hathorprocessing import save_result, read_prev_result


class VitalAperiodic(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = vital_aperiodic.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in vital_aperiodic.read_data(10):
            result.append(data)
