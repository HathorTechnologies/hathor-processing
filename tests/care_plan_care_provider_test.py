...
from hathorprocessing import care_plan_care_provider
from hathorprocessing import save_result, read_prev_result


class CarePlanCareProvider(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = care_plan_care_provider.read_data()
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in care_plan_care_provider.read_data(10):
            result.append(data)
