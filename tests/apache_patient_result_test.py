...
from hathorprocessing import apache_patient_result
from hathorprocessing import save_result, read_prev_result


class ApachePatientResult(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = apache_patient_result.read_data()
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in apache_patient_result.read_data(10):
            result.append(data)
