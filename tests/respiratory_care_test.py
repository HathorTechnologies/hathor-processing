...
from hathorprocessing import respiratory_care
from hathorprocessing import save_result, read_prev_result


class RespiratoryCare(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = respiratory_care.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in respiratory_care.read_data(10):
            result.append(data)
