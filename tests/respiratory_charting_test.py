...
from hathorprocessing import respiratory_charting
from hathorprocessing import save_result, read_prev_result


class RespiratoryCharting(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = respiratory_charting.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in respiratory_charting.read_data(10):
            result.append(data)
