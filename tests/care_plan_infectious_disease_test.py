...
from hathorprocessing import care_plan_infectious_disease
from hathorprocessing import save_result, read_prev_result


class CarePlanInfectiousDisease(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = care_plan_infectious_disease.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in care_plan_infectious_disease.read_data(10):
            result.append(data)
