...
from hathorprocessing import nurse_assessment
from hathorprocessing import save_result, read_prev_result


class NurseAssessment(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = nurse_assessment.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in nurse_assessment.read_data(10):
            result.append(data)
