...
from hathorprocessing import vital_periodic
from hathorprocessing import save_result, read_prev_result


class VitalPeriodic(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = vital_periodic.read_data(10)
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in vital_periodic.read_data(10):
            result.append(data)
