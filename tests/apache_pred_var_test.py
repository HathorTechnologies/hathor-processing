...
from hathorprocessing import apache_pred_var
from hathorprocessing import save_result, read_prev_result


class ApachePredVar(unittest.TestCase):
    ...
    def test_read(self):
        ...
        env.start()
        result = apache_pred_var.read_data()
    ...
    def test_save_result(self):
        ...
        env.start()
        result = []
        for data in apache_pred_var.read_data(10):
            result.append(data)
